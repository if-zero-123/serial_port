...
enum
{
    ...
    SHELL_TEXT_INFO,                                    /**< shell��Ϣ */
#endif
    SHELL_TEXT_CMD_TOO_LONG,                            /**< ������� */
    SHELL_TEXT_CMD_LIST,                                /**< ��ִ�������б����� */
    SHELL_TEXT_VAR_LIST,                                /**< �����б����� */
    SHELL_TEXT_USER_LIST,                               /**< �û��б����� */
    SHELL_TEXT_KEY_LIST,                                /**< �����б����� */
    SHELL_TEXT_CMD_NOT_FOUND,                           /**< ����δ�ҵ� */
    SHELL_TEXT_POINT_CANNOT_MODIFY,                     /**< ָ������������޸� */
    SHELL_TEXT_VAR_READ_ONLY_CANNOT_MODIFY,             /**< ֻ�������������޸� */
    SHELL_TEXT_NOT_VAR,                                 /**< ����Ǳ��� */
    SHELL_TEXT_VAR_NOT_FOUND,                           /**< ����δ�ҵ� */
    SHELL_TEXT_HELP_HEADER,                             /**< helpͷ */
    SHELL_TEXT_PASSWORD_HINT,                           /**< ����������ʾ */
    SHELL_TEXT_PASSWORD_ERROR,                          /**< ������� */
    SHELL_TEXT_CLEAR_CONSOLE,                           /**< ��տ���̨ */
    SHELL_TEXT_CLEAR_LINE,                              /**< ��յ�ǰ�� */
    SHELL_TEXT_TYPE_CMD,                                /**< �������� */
    SHELL_TEXT_TYPE_VAR,                                /**< �������� */
    SHELL_TEXT_TYPE_USER,                               /**< �û����� */
    SHELL_TEXT_TYPE_KEY,                                /**< �������� */
    SHELL_TEXT_TYPE_NONE,                               /**< �Ƿ����� */
...
static const char *shellText[] =
{
    ...
    [SHELL_TEXT_INFO] =
    "\r\n"
    "   __       __  __            ____           ______  _____  __\r\n"
    "  / /  ___ / /_/ /____ ____  / __/__  ____  / __/  |/  / / / /\r\n"
    " / /__/ -_) __/ __/ -_) __/ / _// _ \\/ __/ _\\ \\/ /|_/ / /_/ / \r\n"
    "/____/\\__/\\__/\\__/\\__/_/   /_/  \\___/_/   /___/_/  /_/\\____/  \r\n"
    "                                                              \r\n"
 ...
 * 
 * @return signed char 0 ��ǰ�û����и�����Ȩ��
 * @return signec char -1 ��ǰ�û������и�����Ȩ��
 */
 ...
 * 
 * @param shell shell����
 * @param direction ɾ������ {@code 1}ɾ�����ǰ�ַ� {@code -1}ɾ����괦�ַ�
 */
 ...
 * @param cmd ����
 * @param base ƥ���������ַ
 * @param compareLength ƥ���ַ�������
 * @return ShellCommand* ƥ�䵽������
 */
ShellCommand* shellSeekCommand(Shell *shell,
                               const char *cmd,
                               ShellCommand *base,
